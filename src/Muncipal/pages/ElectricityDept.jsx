...
export default function ElectricityDept() {
  ...
  const fetchData = () => {}; // Dummy to prevent errors
  ...
  useEffect(() => {
    ...
    const fetchInitial = async () => {
      try {
        setLoading(true);
        const wData = await getWorkersByDepartment('Electricity');
        setWorkersList(wData);
        
        unsub = listenComplaintsByDepartment('Electricity', (data) => {
    ...
    if (userData.role === 'admin' && userData.department && userData.department !== 'Electricity') {
      navigate('/admin');
    } else {
      fetchInitial();
    }
      ...
      <div className="admin-main">
        ...
        <main className="admin-content">
          <div className="admin-page-header">
            <div>
              <p className="breadcrumb">Admin &rsaquo; Departments &rsaquo; Electricity</p>
              <h1 className="admin-page-title">Electricity Department</h1>
            </div>
