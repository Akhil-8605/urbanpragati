  ...
  useEffect(() => {
    ...
    const fetchInitial = async () => {
      try {
        ...
        unsub = listenComplaintsByDepartment('Road Repair', (data) => {
          const mappedComplaints = data.map(c => {
            ...
            return {
              ...
              title: c.category || "Road Repair Issue",
    ...
    if (userData.role === 'admin' && userData.department && userData.department !== 'Road Repair') {
      navigate('/admin');
    } else {
      fetchInitial();
    }
